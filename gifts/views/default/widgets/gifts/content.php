...
if (elgg_get_logged_in_user_guid() == $owner) {
    ...
    $gifts = elgg_get_entities_from_metadata(array('type' => 'object', 'subtype' => 'gift', 'limit' => $number,
    ...
    foreach($gifts as $gift) {
        ...
        if (elgg_is_admin_logged_in() || (elgg_get_logged_in_user_guid() == $gift->owner_guid) || (elgg_get_logged_in_user_guid() == $gift->receiver)) {
                ...
                echo $delete_button = elgg_view("output/confirmlink",array('href' => elgg_get_site_url() . "action/gifts/delete?guid=" . $gift->guid,
